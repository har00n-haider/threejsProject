...
class Debugger  {
    ...
    update = () => {
        ...
        "hit pos: "     + this.lastHitPoint.x.toFixed(2) + " , " + 
                          this.lastHitPoint.y.toFixed(2) + " , " +
                          this.lastHitPoint.z.toFixed(2) + "<br>" +
        "camera pos: "  + this.globals.mainCamera.position.x.toFixed(2) + " , " + 
                          this.globals.mainCamera.position.y.toFixed(2) + " , " +
                          this.globals.mainCamera.position.z.toFixed(2)
        ;
    }   
